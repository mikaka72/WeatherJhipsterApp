...
public class Current {
	...
	public Current(String temp_f, Condition condition, String temp_c, String wind_degree, String wind_dir,
			String wind_kph, String is_day, String pressure_in, String humidity, String vis_km, String pressure_mb,
			String precip_mm, String wind_mph, String last_updated_epoch, String cloud, String feelslike_f,
			String last_updated, String feelslike_c, String precip_in, String vis_miles) {
		super();
		this.temp_f = temp_f;
